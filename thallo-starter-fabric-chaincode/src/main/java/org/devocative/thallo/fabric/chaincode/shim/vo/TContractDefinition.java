...
public class TContractDefinition implements ContractDefinition {
	...
	public TContractDefinition(ContractInterface contract) {
		...
		try {
			...
			unknownTx = new TTxFunction(m, contract);
	...
	public TxFunction addTxFunction(Method m) {
		final TxFunction txFn = new TTxFunction(m, contract);
