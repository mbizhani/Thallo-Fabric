...
import org.devocative.thallo.fabric.gateway.dto.FabricTransactionInfo;
...
public class FabricTransactionReaderHandler {
	private static final Logger log = LoggerFactory.getLogger(FabricTransactionReaderHandler.class);
	...
	public FabricTransactionReaderHandler(Channel channel, ThreadPoolTaskExecutor taskExecutor) {
	...
	public void readBlockFrom(long startBlockNumber, Consumer<FabricTransactionInfo> consumer) {
	...
	public void registerBlockListener(Consumer<FabricTransactionInfo> consumer) {
		try {
	...
	private void processBlock(BlockInfo.EnvelopeInfo envelopeInfo, Long blockNumber, Consumer<FabricTransactionInfo> consumer) {
		if (envelopeInfo.getType() == TRANSACTION_ENVELOPE) {
			...
			for (BlockInfo.TransactionEnvelopeInfo.TransactionActionInfo transactionActionInfo : transactionEnvelopeInfo.getTransactionActionInfos()) {
				...
				final FabricTransactionInfo hlfBlockDTO = new FabricTransactionInfo(
					blockNumber,
					transactionId,
